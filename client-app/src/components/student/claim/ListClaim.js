                ...
                <table className="mt-6 w-[100%]">
                    <thead>
                        <tr className="bg-gray-200 text-gray-600">
                            ...
                            <th className="border-4 border-white">Mã giáo viên</th>
                            <th className="border-4 border-white">Tên giáo viên</th>
...
const Claim = (claim, index) => {
    return (
        <tr className="border-b">
            ...
            <td className="text-center">{claim.teacher.id}</td>
            <td className="pl-4">{claim.teacher.name}</td>
